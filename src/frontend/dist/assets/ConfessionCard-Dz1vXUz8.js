import { c as createLucideIcon, j as jsxRuntimeExports, e as Slot, a as cn, f as cva, R as React, r as reactExports, g as ReactDOM, b as useQueryClient, B as Button, S as Skeleton, h as formatRelativeTime } from "./index-D3c2QSMf.js";
import { u as useActor, a as useQuery, R as Reaction, c as createActor } from "./backend-DXg3kHH9.js";
...
function formatRelativeTimeFromBigint(ts) {
...
function ConfessionCard({
  ...
  const { id, text, tags, timestamp, isHidden, reactions, commentCount } = confession;
  ...
  const commentMutation = useMutation({
    mutationFn: async (text2) => {
      if (!actor) throw new Error("Backend unavailable");
      return actor.addComment(id, text2);
    },
    onSuccess: () => {
      setCommentText("");
      queryClient.invalidateQueries({ queryKey: ["comments", String(id)] });
      queryClient.invalidateQueries({ queryKey: ["public-confessions"] });
      ue.success("Comment posted anonymously!", { duration: 3e3 });
    }
  });
...
${getFeedUrl()}`
  ...
  const totalReactions = Number(reactions.relatable) + Number(reactions.crazy) + Number(reactions.sad) + Number(reactions.funny);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "article",
    {
      ...
      children: [
        badge && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 pt-4 pb-0", children: badge }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("px-5", badge ? "pt-3" : "pt-5", "pb-0"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            className: cn(
        ...
        tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "tag-badge", children: [
              "#",
              tag.toUpperCase()
            ] }, tag))
          }
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tabular-nums", children: count > 0 ? count : label })
                    ]
                  },
                  key
                );
              }),
              totalReactions > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-auto text-[11px] text-muted-foreground tabular-nums", children: [
                totalReactions,
                " reaction",
                totalReactions !== 1 ? "s" : ""
              ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-5 pt-3 pb-0 border-t border-border/40 mt-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tabular-nums", children: Number(commentCount) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-[11px] mr-1 select-none", children: "Share:" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  variant: "ghost",
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "svg",
                    {
                      ...
                      "aria-hidden": "true",
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.736-8.859L1.254 2.25H8.08l4.259 5.63L18.244 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77z" })
                    }
                  )
                }
              ),
        ...
        showComments && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              ] }) : comments.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs text-center py-2", children: "No comments yet. Be the first to react anonymously." }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: comments.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground leading-snug", children: c.text }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground", children: formatRelativeTime(c.timestamp) })
                      ]
                    },
                    String(c.id)
                  ))
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 items-end", "data-ocid": "comment-form", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Textarea,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: commentMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: "w-4 h-4" })
                  }
                )
              ] })
            ]
