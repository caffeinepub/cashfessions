import { q as commonjsGlobal, t as getDefaultExportFromCjs, r as reactExports, v as clsx, R as React, w as invariant, u as useIsMobile, j as jsxRuntimeExports, S as Skeleton } from "./index-DOhjICs9.js";
...
function toShortLabel(tag) {
  return CATEGORY_SHORT_LABELS[tag.toLowerCase()] ?? tag;
}
const SKELETON_HEIGHTS = ["h-24", "h-40", "h-32", "h-56", "h-20", "h-36"];
function ChartSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 h-56 w-full items-end px-4", children: SKELETON_HEIGHTS.map((h2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: `flex-1 rounded-t-md ${h2}` }, h2)) });
}
function CustomTooltip({ active, payload }) {
  if (!active || !(payload == null ? void 0 : payload.length)) return null;
  const d2 = payload[0].payload;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-elevated px-4 py-3 text-sm shadow-lg min-w-[140px]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground", children: CATEGORY_LABELS[d2.tag] ?? d2.label }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground mt-0.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-bold text-base", children: d2.count }),
      " ",
      "confession",
      d2.count !== 1 ? "s" : ""
    ] }),
    d2.isTop && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-[10px] font-semibold uppercase tracking-wider text-primary", children: "🏆 Most Popular" })
  ] });
}
function Analytics() {
  ...
  const chartData = rawAnalytics.map((a2) => ({
    tag: a2.tag,
    label: toLabel(a2.tag),
    shortLabel: toShortLabel(a2.tag),
    count: Number(a2.count),
    isTop: false
  })).sort((a2, b2) => b2.count - a2.count).map((d2, i, arr) => ({
    ...d2,
    isTop: i === 0 && arr.length > 0 && d2.count > 0
  }));
  const topCategory = chartData.find((d2) => d2.isTop);
  const totalConfessions = chartData.reduce((sum, d2) => sum + d2.count, 0);
  const chartHeight = isMobile ? 240 : 340;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-card border-b border-border/60 py-8 px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl sm:text-4xl font-semibold text-foreground tracking-tight", children: "Category Analytics" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1.5 text-muted-foreground text-sm sm:text-base", children: "Which investment category carries the most shame? The data speaks for itself." })
        ]
      }
    ) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-muted/30 border-b border-border/40 px-4 sm:px-6 lg:px-8 py-5 sm:py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs uppercase tracking-wider font-semibold", children: "Total Confessions" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-3xl font-bold text-foreground", children: isLoading || actorLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-12" }) : totalConfessions })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          className: "card-elevated p-4 flex flex-col gap-1",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs uppercase tracking-wider font-semibold", children: "Categories" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-3xl font-bold text-foreground", children: isLoading || actorLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-8" }) : chartData.filter((d2) => d2.count > 0).length })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs uppercase tracking-wider font-semibold", children: "Top Category" }),
            isLoading || actorLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-24" }) : topCategory ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-2xl font-bold text-primary truncate", children: topCategory.label }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-sm", children: "None yet" })
          ]
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start sm:items-center justify-between mb-5 gap-2 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-lg sm:text-xl font-semibold text-foreground", children: "Confessions by Category" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs mt-0.5", children: "Tallied from all public submissions" })
              ] }),
              topCategory && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-semibold text-primary", children: [
                "🏆 ",
                topCategory.label
              ] }) })
            ] }),
            isLoading || actorLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChartSkeleton, {}) : chartData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-lg text-foreground", children: "No data yet" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm max-w-xs", children: "Analytics will appear once confessions are submitted with category tags." })
                ]
              }
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: chartHeight, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              BarChart,
              {
                data: chartData,
                margin: {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(Bar, { dataKey: "count", radius: [6, 6, 0, 0], children: [
                    ...
                    chartData.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Cell,
                      {
                        fill: entry.isTop ? "oklch(var(--primary))" : "oklch(var(--accent) / 0.7)"
                      },
                      entry.tag
                    ))
                  ] })
      ...
      !isLoading && !actorLoading && chartData.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: chartData.map((d2, index) => {
            const pct = totalConfessions > 0 ? Math.round(d2.count / totalConfessions * 100) : 0;
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "flex items-center gap-3 sm:gap-4 px-4 sm:px-5 py-3 sm:py-4",
                "data-ocid": `analytics-row-${d2.tag.replace(/\s+/g, "-")}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-sm w-5 text-right shrink-0", children: index + 1 }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1.5 flex-wrap", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-sm text-foreground truncate", children: CATEGORY_LABELS[d2.tag] ?? d2.label }),
                      d2.isTop && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-wider text-primary bg-primary/10 px-2 py-0.5 rounded-full border border-primary/25 shrink-0", children: "Most Popular" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 w-full bg-muted rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        style: {
                          width: `${pct}%`,
                          background: d2.isTop ? "oklch(var(--primary))" : "oklch(var(--accent) / 0.7)"
                        }
                      }
                    ) })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-bold text-sm tabular-nums", children: d2.count }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground text-xs tabular-nums w-8 sm:w-9 text-right", children: [
                      pct,
                      "%"
                    ] })
                  ] })
