import { c as createLucideIcon, j as jsxRuntimeExports, f as Slot, a as cn, g as cva, R as React, r as reactExports, h as ReactDOM, i as formatRelativeTime, d as useQueryClient, u as useIsMobile, B as Button, S as Skeleton } from "./index-DOhjICs9.js";
import { u as useActor, a as useQuery, R as Reaction, c as createActor } from "./backend-D5_D6H8M.js";
import { u as useMutation, L as LoaderCircle, T as Textarea } from "./textarea-B0bica--.js";
/**
...
async function generateConfessionImage(elementId) {
...
function downloadImage(dataUrl, filename = "gothicgarden-confession.png") {
...
function buildSocialCaption(url, confession) {
  if (!confession) {
...
${url}`;
  ...
  const snippet = confession.text.length > 120 ? `"${confession.text.slice(0, 120)}…"` : `"${confession.text}"`;
  const topTags = confession.tags.slice(0, 2).map((t) => `#${t.replace(/\s+/g, "")}`).join(" ");
...
function ShareCardCanvas({ confession, id }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        ...
        height: "auto",
        minHeight: "340px",
        background: "linear-gradient(145deg, #1e1a14 0%, #16120c 50%, #1a1710 100%)",
        ...
        gap: "0",
        overflow: "hidden",
        boxShadow: "0 8px 40px rgba(0,0,0,0.6), 0 0 0 1px rgba(186,145,72,0.15)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              ...
              right: 0,
              height: "4px",
              background: "linear-gradient(90deg, #b8913a 0%, #e0c068 50%, #b8913a 100%)",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  children: "investment therapy community"
                }
              )
            ]
          }
        ...
        reactionEntries.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              display: "flex",
            ...
            children: reactionEntries.map(([key, count]) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "14px" }, children: emoji }),
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  children: "gothicgarden.caffeine.xyz"
                }
              )
            ]
          }
...
var bt = 1, yt = class {
  constructor() {
    this.subscribe = (e2) => (this.subscribers.push(e2), () => {
      let t = this.subscribers.indexOf(e2);
      this.subscribers.splice(t, 1);
    });
    this.publish = (e2) => {
      this.subscribers.forEach((t) => t(e2));
    };
    this.addToast = (e2) => {
    ...
    this.create = (e2) => {
      var S;
      let { message: t, ...a2 } = e2, u2 = typeof (e2 == null ? void 0 : e2.id) == "number" || ((S = e2.id) == null ? void 0 : S.length) > 0 ? e2.id : bt++, f2 = this.toasts.find((g) => g.id === u2), w = e2.dismissible === void 0 ? true : e2.dismissible;
      return this.dismissedToasts.has(u2) && this.dismissedToasts.delete(u2), f2 ? this.toasts = this.toasts.map((g) => g.id === u2 ? (this.publish({ ...g, ...e2, id: u2, title: t }), { ...g, ...e2, id: u2, dismissible: w, title: t }) : g) : this.addToast({ title: t, ...a2, dismissible: w, id: u2 }), u2;
    };
    this.dismiss = (e2) => (this.dismissedToasts.add(e2), e2 || this.toasts.forEach((t) => {
      this.subscribers.forEach((a2) => a2({ id: t.id, dismiss: true }));
    }), this.subscribers.forEach((t) => t({ id: e2, dismiss: true })), e2);
    this.message = (e2, t) => this.create({ ...t, message: e2 });
    this.error = (e2, t) => this.create({ ...t, message: e2, type: "error" });
    this.success = (e2, t) => this.create({ ...t, type: "success", message: e2 });
    this.info = (e2, t) => this.create({ ...t, type: "info", message: e2 });
    this.warning = (e2, t) => this.create({ ...t, type: "warning", message: e2 });
    this.loading = (e2, t) => this.create({ ...t, type: "loading", message: e2 });
    this.promise = (e2, t) => {
      if (!t) return;
      let a2;
      t.loading !== void 0 && (a2 = this.create({ ...t, promise: e2, type: "loading", message: t.loading, description: typeof t.description != "function" ? t.description : void 0 }));
      let u2 = e2 instanceof Promise ? e2 : e2(), f2 = a2 !== void 0, w, S = u2.then(async (i) => {
        if (w = ["resolve", i], React.isValidElement(i)) f2 = false, this.create({ id: a2, type: "default", message: i });
        else if (ie(i) && !i.ok) {
          f2 = false;
    ...
    this.custom = (e2, t) => {
      ...
      return this.create({ jsx: e2(a2), id: a2, ...t }), a2;
    };
    this.getActiveToasts = () => this.toasts.filter((e2) => !this.dismissedToasts.has(e2.id));
    this.subscribers = [], this.toasts = [], this.dismissedToasts = /* @__PURE__ */ new Set();
  }
}, v = new yt(), ne = (n, e2) => {
  let t = (e2 == null ? void 0 : e2.id) || bt++;
  return v.addToast({ title: n, ...e2, id: t }), t;
...
function wt(n, { insertAt: e2 } = {}) {
  if (typeof document == "undefined") return;
  let t = document.head || document.getElementsByTagName("head")[0], a2 = document.createElement("style");
  a2.type = "text/css", e2 === "top" && t.firstChild ? t.insertBefore(a2, t.firstChild) : t.appendChild(a2), a2.styleSheet ? a2.styleSheet.cssText = n : a2.appendChild(document.createTextNode(n));
}
...
function xe(n) {
  let [e2, t] = n.split("-"), a2 = [];
  return e2 && a2.push(e2), t && a2.push(t), a2;
}
var ve = (n) => {
  var Dt, Pt, Nt, Bt, Ct, kt, It, Mt, Ht, At, Lt;
  let { invert: e2, toast: t, unstyled: a2, interacting: u2, setHeights: f2, visibleToasts: w, heights: S, index: g, toasts: i, expanded: D, removeToast: T2, defaultRichColors: F2, closeButton: et, style: ut, cancelButtonStyle: ft, actionButtonStyle: l, className: ot = "", descriptionClassName: at = "", duration: X, position: st, gap: pt, loadingIcon: rt, expandByDefault: B, classNames: s, icons: P, closeButtonAriaLabel: nt = "Close toast", pauseWhenPageIsHidden: it } = n, [Y, C] = React.useState(null), [lt, J] = React.useState(null), [W, H] = React.useState(false), [A2, mt] = React.useState(false), [L2, z2] = React.useState(false), [ct, d] = React.useState(false), [h, y] = React.useState(false), [R, j] = React.useState(0), [p, _] = React.useState(0), O = React.useRef(t.duration || X || Wt), G = React.useRef(null), k = React.useRef(null), Vt = g === 0, Ut = g + 1 <= w, N = t.type, V2 = t.dismissible !== false, Kt = t.className || "", Xt = t.descriptionClassName || "", dt = React.useMemo(() => S.findIndex((r) => r.toastId === t.id) || 0, [S, t.id]), Jt = React.useMemo(() => {
    var r;
    return (r = t.closeButton) != null ? r : et;
  }, [t.closeButton, et]), Tt = React.useMemo(() => t.duration || X || Wt, [t.duration, X]), gt = React.useRef(0), U2 = React.useRef(0), St = React.useRef(0), K = React.useRef(null), [Gt, Qt] = st.split("-"), Rt = React.useMemo(() => S.reduce((r, m, c) => c >= dt ? r : r + m.height, 0), [S, dt]), Et = Ft(), qt = t.invert || e2, ht = N === "loading";
  U2.current = React.useMemo(() => dt * pt + Rt, [dt, Rt]), React.useEffect(() => {
    O.current = Tt;
  }, [Tt]), React.useEffect(() => {
    H(true);
  }, []), React.useEffect(() => {
    ...
    if (r) {
      ...
      return _(m), f2((c) => [{ toastId: t.id, height: m, position: t.position }, ...c]), () => f2((c) => c.filter((b) => b.toastId !== t.id));
    }
  }, [f2, t.id]), React.useLayoutEffect(() => {
    if (!W) return;
    let r = k.current, m = r.style.height;
    r.style.height = "auto";
    let c = r.getBoundingClientRect().height;
    r.style.height = m, _(c), f2((b) => b.find((x) => x.toastId === t.id) ? b.map((x) => x.toastId === t.id ? { ...x, height: c } : x) : [{ toastId: t.id, height: c, position: t.position }, ...b]);
  }, [W, t.title, t.description, f2, t.id]);
  let $ = React.useCallback(() => {
    mt(true), j(U2.current), f2((r) => r.filter((m) => m.toastId !== t.id)), setTimeout(() => {
      T2(t);
    }, we);
  }, [t, T2, f2, U2]);
  React.useEffect(() => {
  ...
  }, [D, u2, t, N, it, Et, $]), React.useEffect(() => {
    t.delete && $();
  }, [$, t.delete]);
  function Zt() {
    var r, m, c;
  ...
  return React.createElement("li", { tabIndex: 0, ref: k, className: M(ot, Kt, s == null ? void 0 : s.toast, (Dt = t == null ? void 0 : t.classNames) == null ? void 0 : Dt.toast, s == null ? void 0 : s.default, s == null ? void 0 : s[N], (Pt = t == null ? void 0 : t.classNames) == null ? void 0 : Pt[N]), "data-sonner-toast": "", "data-rich-colors": (Nt = t.richColors) != null ? Nt : F2, "data-styled": !(t.jsx || t.unstyled || a2), "data-mounted": W, "data-promise": !!t.promise, "data-swiped": h, "data-removed": A2, "data-visible": Ut, "data-y-position": Gt, "data-x-position": Qt, "data-index": g, "data-front": Vt, "data-swiping": L2, "data-dismissible": V2, "data-type": N, "data-invert": qt, "data-swipe-out": ct, "data-swipe-direction": lt, "data-expanded": !!(D || B && W), style: { "--index": g, "--toasts-before": g, "--z-index": i.length - g, "--offset": `${A2 ? R : U2.current}px`, "--initial-height": B ? "auto" : `${p}px`, ...ut, ...t.style }, onDragEnd: () => {
    z2(false), C(null), K.current = null;
  }, onPointerDown: (r) => {
    ht || !V2 || (G.current = /* @__PURE__ */ new Date(), j(U2.current), r.target.setPointerCapture(r.pointerId), r.target.tagName !== "BUTTON" && (z2(true), K.current = { x: r.clientX, y: r.clientY }));
  }, onPointerUp: () => {
    var x, Q, q, Z2;
    if (ct || !V2) return;
    K.current = null;
    ...
    if (Math.abs(b) >= ye || I > 0.11) {
      j(U2.current), (Z2 = t.onDismiss) == null || Z2.call(t, t), J(Y === "x" ? r > 0 ? "right" : "left" : m > 0 ? "down" : "up"), $(), d(true), y(false);
      return;
    }
    z2(false), C(null);
  }, onPointerMove: (r) => {
    ...
    let x = { x: 0, y: 0 };
    Y === "y" ? (I.includes("top") || I.includes("bottom")) && (I.includes("top") && c < 0 || I.includes("bottom") && c > 0) && (x.y = c) : Y === "x" && (I.includes("left") || I.includes("right")) && (I.includes("left") && b < 0 || I.includes("right") && b > 0) && (x.x = b), (Math.abs(x.x) > 0 || Math.abs(x.y) > 0) && y(true), (Z2 = k.current) == null || Z2.style.setProperty("--swipe-amount-x", `${x.x}px`), (zt = k.current) == null || zt.style.setProperty("--swipe-amount-y", `${x.y}px`);
  } }, Jt && !t.jsx ? React.createElement("button", { "aria-label": nt, "data-disabled": ht, "data-close-button": true, onClick: ht || !V2 ? () => {
  } : () => {
    var r;
    ...
    var m, c;
    tt(t.cancel) && V2 && ((c = (m = t.cancel).onClick) == null || c.call(m, r), $());
...
function Te(n, e2) {
  let t = {};
  return [n, e2].forEach((a2, u2) => {
    let f2 = u2 === 1, w = f2 ? "--mobile-offset" : "--offset", S = f2 ? ge : me;
    function g(i) {
      ["top", "right", "bottom", "left"].forEach((D) => {
        t[`${w}-${D}`] = typeof i == "number" ? `${i}px` : i;
      });
    }
    typeof a2 == "number" || typeof a2 == "string" ? g(a2) : typeof a2 == "object" ? ["top", "right", "bottom", "left"].forEach((i) => {
      a2[i] === void 0 ? t[`${w}-${i}`] = S : t[`${w}-${i}`] = typeof a2[i] == "number" ? `${a2[i]}px` : a2[i];
    }) : g(S);
  }), t;
}
reactExports.forwardRef(function(e2, t) {
  let { invert: a2, position: u2 = "bottom-right", hotkey: f2 = ["altKey", "KeyT"], expand: w, closeButton: S, className: g, offset: i, mobileOffset: D, theme: T2 = "light", richColors: F2, duration: et, style: ut, visibleToasts: ft = pe, toastOptions: l, dir: ot = _t(), gap: at = be, loadingIcon: X, icons: st, containerAriaLabel: pt = "Notifications", pauseWhenPageIsHidden: rt } = e2, [B, s] = React.useState([]), P = React.useMemo(() => Array.from(new Set([u2].concat(B.filter((d) => d.position).map((d) => d.position)))), [B, u2]), [nt, it] = React.useState([]), [Y, C] = React.useState(false), [lt, J] = React.useState(false), [W, H] = React.useState(T2 !== "system" ? T2 : typeof window != "undefined" && window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"), A2 = React.useRef(null), mt = f2.join("+").replace(/Key/g, "").replace(/Digit/g, ""), L2 = React.useRef(null), z2 = React.useRef(false), ct = React.useCallback((d) => {
    s((h) => {
      var y;
  ...
  return React.useEffect(() => v.subscribe((d) => {
    ...
    if (T2 === "system" && (window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches ? H("dark") : H("light")), typeof window == "undefined") return;
    ...
    let d = (h) => {
      var R, j;
      f2.every((p) => h[p] || h.code === p) && (C(true), (R = A2.current) == null || R.focus()), h.code === "Escape" && (document.activeElement === A2.current || (j = A2.current) != null && j.contains(document.activeElement)) && C(false);
    };
  ...
  }, [A2.current]), React.createElement("section", { ref: t, "aria-label": `${pt} ${mt}`, tabIndex: -1, "aria-live": "polite", "aria-relevant": "additions text", "aria-atomic": "false", suppressHydrationWarning: true }, P.map((d, h) => {
    var j;
    let [y, R] = d.split("-");
    return B.length ? React.createElement("ol", { key: d, dir: ot === "auto" ? _t() : ot, tabIndex: -1, ref: A2, className: g, "data-sonner-toaster": true, "data-theme": W, "data-y-position": y, "data-lifted": Y && B.length > 1 && !w, "data-x-position": R, style: { "--front-toast-height": `${((j = nt[0]) == null ? void 0 : j.height) || 0}px`, "--width": `${he}px`, "--gap": `${at}px`, ...ut, ...Te(i, D) }, onBlur: (p) => {
      z2.current && !p.currentTarget.contains(p.relatedTarget) && (z2.current = false, L2.current && (L2.current.focus({ preventScroll: true }), L2.current = null));
    }, onFocus: (p) => {
      p.target instanceof HTMLElement && p.target.dataset.dismissible === "false" || z2.current || (z2.current = true, L2.current = p.relatedTarget);
      ...
      var O, G;
      return React.createElement(ve, { key: p.id, icons: st, index: _, toast: p, defaultRichColors: F2, duration: (O = l == null ? void 0 : l.duration) != null ? O : et, className: l == null ? void 0 : l.className, descriptionClassName: l == null ? void 0 : l.descriptionClassName, invert: a2, visibleToasts: ft, closeButton: (G = l == null ? void 0 : l.closeButton) != null ? G : S, interacting: lt, position: d, style: l == null ? void 0 : l.style, unstyled: l == null ? void 0 : l.unstyled, classNames: l == null ? void 0 : l.classNames, cancelButtonStyle: l == null ? void 0 : l.cancelButtonStyle, actionButtonStyle: l == null ? void 0 : l.actionButtonStyle, removeToast: ct, toasts: B.filter((k) => k.position == p.position), heights: nt.filter((k) => k.position == p.position), setHeights: it, expandByDefault: w, gap: at, loadingIcon: X, expanded: Y, pauseWhenPageIsHidden: rt, swipeDirections: e2.swipeDirections });
    })) : null;
  }));
});
const REACTIONS = [
...
function getConfessionUrl(confessionId) {
...
function ConfessionCard({
  ...
  const cardId = reactExports.useId().replace(/:/g, "-");
  ...
  const handleShare = reactExports.useCallback(
    async (platform) => {
      ...
      try {
        ...
        ue.error("Couldn't generate card image.", { duration: 4e3 });
      } finally {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ShareCardCanvas, { confession, id: shareCardId }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "article",
      {
        className: cn(
        ...
        children: [
          badge && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pt-4 pb-0", children: badge }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("px-4", badge ? "pt-3" : "pt-4", "pb-0"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: cn(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: cn(
                "px-4 pt-3 pb-0",
                isMobile ? "grid grid-cols-2 gap-2" : "flex items-center gap-1 flex-wrap"
              ),
              ...
              children: [
                ...
                !isMobile && totalReactions > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-auto text-[11px] text-muted-foreground tabular-nums", children: [
                  totalReactions,
                  " reaction",
                  totalReactions !== 1 ? "s" : ""
                ] })
          ...
          isMobile && totalReactions > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] text-muted-foreground tabular-nums", children: [
            totalReactions,
            " reaction",
            totalReactions !== 1 ? "s" : ""
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 pt-3 pb-0 border-t border-border/40 mt-3", children: [
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      shareLoading === "twitter" ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-3.5 h-3.5 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "svg",
                        {
                          viewBox: "0 0 24 24",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      shareLoading === "linkedin" ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-3.5 h-3.5 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "svg",
                        {
                          viewBox: "0 0 24 24",
                          className: "w-3.5 h-3.5 fill-current shrink-0",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      shareLoading === "whatsapp" ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-3.5 h-3.5 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "svg",
                        {
                          viewBox: "0 0 24 24",
                          className: "w-3.5 h-3.5 fill-current shrink-0",
