import { c as createLucideIcon, b as useAuth, d as useQueryClient, r as reactExports, j as jsxRuntimeExports, e as LayoutDashboard, B as Button, S as Skeleton } from "./index-DOhjICs9.js";
...
import { u as useMutation } from "./textarea-B0bica--.js";
...
function DashboardSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-3", children: SKELETON_KEYS.map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-52 w-full rounded-lg" }, k)) });
}
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 max-w-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl sm:text-3xl text-foreground", children: "Owner Dashboard" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs mt-2", children: "On mobile, your browser will open the Internet Identity login page. Make sure pop-ups are not blocked." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
...
function Dashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-5 sm:space-y-6", children: [
          ...
          children: TABS.map(({ key, label }) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                className: `flex items-center gap-1.5 px-4 py-2.5 rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring flex-1 sm:flex-none justify-center min-h-[44px] ${activeTab === key ? "bg-card text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`,
                "data-ocid": `tab-${key}`,
                children: [
                  label,
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
