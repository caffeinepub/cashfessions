import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, u as useIsMobile, B as Button, a as cn } from "./index-DOhjICs9.js";
import { u as useActor, c as createActor } from "./backend-D5_D6H8M.js";
import { u as useMutation, T as Textarea, L as LoaderCircle } from "./textarea-B0bica--.js";
import { M as MotionConfigContext, i as isHTMLElement, u as useConstant, P as PresenceContext, a as usePresence, b as useIsomorphicLayoutEffect, L as LayoutGroupContext, m as motion } from "./proxy-SUiY6OB1.js";
import { L as Lock } from "./lock-Df-e1ZXk.js";
/**
...
function Home() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative flex flex-col items-center justify-center px-4 pt-12 sm:pt-20 pb-10 sm:pb-12 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-5 px-4 py-2 rounded-full bg-card border border-border text-muted-foreground text-sm", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-3xl sm:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-4", children: [
              "What's your biggest",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "investment mistake?" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base sm:text-xl leading-relaxed mb-8", children: "A safe space to confess, heal, and grow — where every bad trade becomes a lesson. Anonymous. Honest. Together." }),
